...
<?php
	...
	echo $this->Form->input( 'username', ['type' => 'text', 'label' => __('Username'), 'required' => true, 'maxlength' => 16 ] ), "\n";
	...
	echo $this->Form->input( 'language', ['type' => 'text',	 	'label' => __('Language (ISO 639 Code)'), 'value' => $language, 'maxlength' => 6 ] ), "\n";
